    ...
    return (
        <footer className="row-start-3 grid place-items-center gap-2 text-center py-6 pb-20 sm:pb-24">
            <div className="flex space-x-4 mb-2">
                <Link href="/impressum" className="text-xs text-gray-500 dark:text-gray-400 hover:underline">
                    Imprint / Impressum
                </Link>
                <Link href="/datenschutz" className="text-xs text-gray-500 dark:text-gray-400 hover:underline">
                    Privacy / Datenschutz
                </Link>
            </div>
